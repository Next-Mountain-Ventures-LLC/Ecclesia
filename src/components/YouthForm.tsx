...
export default function YouthForm() {
  const defaultFormData = {
    ...
    phone: "",
    message: "",
    form_name: "Youth Gathering Form"
  };
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            required
            className="w-full px-3 py-2 border border-accent-200 rounded-md focus:outline-none focus:ring-2 focus:ring-accent-500 focus:border-transparent"
          />
        </div>
      ...
      <div>
        ...
        <textarea
          ...
          rows={4}
          className="w-full px-3 py-2 border border-accent-200 rounded-md focus:outline-none focus:ring-2 focus:ring-accent-500 focus:border-transparent"
          placeholder="Let us know if you have any questions or need specific information about the Youth Gathering..."
        />
      </div>
      ...
      {submitStatus === "success" && (
        <div className="p-4 bg-green-100 border border-green-400 text-green-700 rounded">
          ...
          <p className="text-sm">Someone from our Youth team will contact you soon with more details about our Wednesday gathering. We look forward to meeting you!</p>
        </div>
      )}

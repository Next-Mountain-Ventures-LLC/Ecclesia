...
export default function MidtownForm() {
  const defaultFormData = {
    name: "",
    email: "",
    phone: "",
    message: "",
    form_name: "Midtown Gathering Form"
  };
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <textarea
          ...
          rows={4}
          className="w-full px-3 py-2 border border-primary-200 rounded-md focus:outline-none focus:ring-2 focus:ring-accent-500 focus:border-transparent"
          placeholder="Let us know if you have any questions or need specific information about the Midtown Gathering..."
        />
      </div>
      ...
      >
        {isSubmitting ? "Submitting..." : "Join Midtown Gathering"}
      </button>

      {submitStatus === "success" && (
        <div className="p-4 bg-green-100 border border-green-400 text-green-700 rounded">
          <h4 className="font-medium mb-1">Thank you for your interest!</h4>
          <p className="text-sm">Someone from our Midtown team will contact you soon with more details about our Sunday gathering. We look forward to meeting you!</p>
        </div>
      )}

          ...
          <div>
            ...
            <div className="space-y-8 mb-8">
              <div className="flex">
                ...
                <div>
                  <h3 className="text-lg font-medium text-primary-800 mb-1">Connect by Phone</h3>
                  <p className="text-muted-foreground">
                    Call us at (918) 555-1234
                  </p>
                </div>
              </div>
              ...
              <div className="flex">
                ...
                <div>
                  <h3 className="text-lg font-medium text-primary-800 mb-1">Email Us</h3>
                  <p className="text-muted-foreground">
                    info@ecclesiatulsa.com
                  </p>
                </div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label htmlFor="message" className="block text-sm font-medium text-primary-700 mb-1">
                    {formType === "join" && "I'm interested in the following gathering(s):"}
                    {formType === "start" && "Tell us about your vision for a new gathering:"}
                    {formType === "serve" && "How would you like to serve with us?"}
                  </label>
                  <textarea
                    id="message"
                    name="message"
                    ...
                    placeholder={
                      formType === "join" 
                      ? "I'm interested in learning more about the Midtown gathering..." 
                      : formType === "start" 
                      ? "I'd like to start a gathering in my neighborhood..."
                      : "I'd like to help serve with children's activities..."
                    }
                  />
                </div>
